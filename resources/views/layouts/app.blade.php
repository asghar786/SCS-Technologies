        ...
        <div class="container">
            <div class="contact-info-area">
                ...
                <div class="contact-info-items wow fadeInUp" data-wow-delay=".5s">
                    <div class="icon">
                        <i class="fa-solid fa-envelope" style="font-size:28px; color:#5A95CF;"></i>
                    </div>
                    <div class="content">
                        <p>Send Email</p>
                ...
                <div class="contact-info-items wow fadeInUp" data-wow-delay=".3s">
                    <div class="icon">
                        <i class="fa-solid fa-phone" style="font-size:28px; color:#5A95CF;"></i>
                    </div>
                    <div class="content">
                        <p>Call Us</p>
